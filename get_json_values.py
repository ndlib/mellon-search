...
def test():
    ''' Test '''
    try:
        _test_get_required_value()
        _test_missing_required_value()
        _test_blank_required_value()
        _test_malformed_json()
        _test_get_optional_value()
        _test_blank_optional_value()
        _test_missing_optional_value()
        print('All tests ran successfully.')
    except:
        print('We have a problem.')
        raise

def _test_get_required_value():
...
def _test_missing_required_value():
...
def _test_blank_required_value():
...
def _test_blank_optional_value():
...
def _test_missing_optional_value():
